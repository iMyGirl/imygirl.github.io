- [Linux深度学习环境配置（ubuntu16.04+nvidia430+cuda8.0.44+cudnn6+anaconda3-5.0.0+tensorflow1.4.0+keras2.1.5）](#linux---------ubuntu1604-nvidia430-cuda8044-cudnn6-anaconda3-500-tensorflow140-keras215-)
  * [写在前面](#写在前面)
  * [步骤](#步骤)
    ...
    + [3. 安装cuda](#3---cuda)
    + [4. 安装cudnn](#4---cudnn)
    + [5. 安装anaconda](#5---anaconda)
    + [6. pip安装Tensorflow与keras](#6-pip--tensorflow-keras)
    + [7. 测试是否为GPU计算](#7------gpu--)
    + [8. 卸载以上部分数据包](#8----------)
    + [9. 安装pycharm 或 vscode](#9---pycharm---vscode)
  * [下载连接](#----)
    + [cuda下载](#cuda--)
    + [cudnn下载](#cudnn--)
    + [anaconda下载](#anaconda--)
